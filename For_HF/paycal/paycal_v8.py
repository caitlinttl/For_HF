            ...
            if os.path.splitext(file)[1]=='.txt' :
                ...
                for labeltxt in os.path.splitext(file)[0]:
                    ...
                    if 'suewcity' in os.path.splitext(file)[0]:
                        ...
                        laberA = 'suewcity'
                        folderN = '(suewcity)'
                    if 'kkmqo' in os.path.splitext(file)[0]:
                        labeler = '鄧惠禎(kkmqo)'
                        labelername = '惠禎'
                        laberN = '鄧惠禎'
                        laberA = 'kkmqo'
                        folderN = '(kkmqo)'
                    if 'hualien22' in os.path.splitext(file)[0]:
                        labeler = '劉家茵(hualien22)'
                        labelername = '家茵'
                        laberN = '劉家茵'
                        laberA = 'hualien22'
                        folderN = '(hualien)'
                    if 'bibi770216' in os.path.splitext(file)[0]:
                        labeler = '許碧芳(bibi770216)'
                        labelername = '碧芳'
                        laberN = '許碧芳'
                        laberA = 'bibi770216'
                        folderN = '(bibi)'
